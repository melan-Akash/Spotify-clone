    ...
    <>
      ...
      <div className="my-6">
        <input 
          ...
          className="w-full max-w-md bg-[#242424] text-white px-5 py-3.5 rounded-full outline-none border-2 border-transparent focus:border-green-800 text-sm placeholder-gray-400"
        />
      </div>
