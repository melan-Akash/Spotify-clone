...
const Sidebar = () => {
  ...
  return (
    <div className="w-[25%] h-full flex flex-col gap-2 text-white hidden lg:flex">
      ...
      <div className="bg-[#121212]/40 backdrop-blur-xl border border-white/5 shadow-2xl h-[20%] rounded-2xl flex flex-col justify-around p-4">
      ...
      <div className="bg-[#121212]/40 backdrop-blur-xl border border-white/5 shadow-2xl h-[80%] rounded-2xl flex flex-col overflow-hidden">
