...
const Sidebar = () => {
  ...
  return (
    <div className="w-[25%] h-full flex flex-col gap-2 text-white hidden lg:flex">
      ...
      <div className="bg-[#121212] h-[20%] rounded-2xl flex flex-col justify-around p-4">
      ...
      <div className="bg-[#121212] h-[80%] rounded-2xl flex flex-col overflow-hidden">
        ...
        <div className="p-4 bg-[#1f1f1f] m-2 rounded-xl font-semibold flex flex-col items-start justify-start gap-1 pl-4 hover:bg-[#282828] transition duration-300">
          <h1>Create your first playlist</h1>
          <p className="font-light text-sm text-gray-400">It's easy we will help you</p>
        ...
        <div className="p-4 bg-[#1f1f1f] m-2 rounded-xl font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4 hover:bg-[#282828] transition duration-300">
          <h1>Let's find some podcast to follow</h1>
          <p className="font-light text-sm text-gray-400">we will keep you update on new episodes</p>
