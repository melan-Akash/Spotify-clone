...
const AddSong = () => {
  ...
  // Form දත්ත ගබඩා කිරීමට අවශ්‍ය State variables
  ...
  // Form එක Submit කරන විට ක්‍රියාත්මක වන Function එක
  const onsubmitHandler = async (e) => {
    e.preventDefault();
    setLoading(true); // Loading එක ආරම්භ කිරීම
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // සාර්ථකව යැවූ පසු Input fields හිස් කිරීම
        setName("");
        setDescription("");
        setAlbum("none");
        setImage(false);
    ...
    setLoading(false); // Loading එක අවසන් කිරීම
  }

  // Database එකේ ඇති ඇල්බම ලැයිස්තුව ලබා ගැනීම (Drop-down එක සඳහා)
  ...
  // Loading state එක true නම් Loading Animation එක පෙන්වීම
  return loading ? (
